...
# Unit testing
The tests are under Eldermap.test<br/><br/>
Unit testing for this project is completed by using PowerMockito ver 1.7.0 and Mockito ver 2.8.0<br/>
The coverage of unit testing is all packages except all activities or part of adapters. Those parts relating with UI setting are not
tested. <br/>
GPS under GPS package is not tested either. This package is using the service provided and supported by Google.inc<br/>
Further details about GPS test case are included under GPS test. 
